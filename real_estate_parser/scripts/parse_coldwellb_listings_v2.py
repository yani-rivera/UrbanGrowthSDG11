...
from scripts.helpers import (
    ...
    count_star_bullets, split_raw_and_parse_line,make_prefile_star)
...
def main(file, config_path, output_dir):
    ...
    if cfg.get("listing_marker") == "NUMBEREDDASH" and cfg.get("auto_masquerade_numdot"):
...
#==================
 ...
 # Ensure agency comes from args
    ...
    outdir = os.path.join(args.output_dir, "coldwellb", year)
    print("outdoe==>",outdir)
#=========
    if rows:
...
if __name__ == "__main__":
    ...
    print("[entry] starting parse_coldwellb_listings_v2.py")
