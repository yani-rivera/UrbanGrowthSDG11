def extract_price(text):
    ...
    # Match L or $ optionally followed by whitespace, then numbers, possibly with commas and a decimal point
    matches = re.findall(r"(?:\$|L)?\s?([\d,.]+)", text)
    candidates = []
...
def parse_eugenia_file(filepath, config_path, neighborhoods_path, output_dir):
