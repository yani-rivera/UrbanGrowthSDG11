...
# in scripts/parse_listings_v1.py
...
def main(file, config_path, output_dir):
    ...
    if  cfg.get("auto_masquerade_numdot"):
...
#=========
    if rows:
        ...
        outpath = outdir+"/"+str.lower(agency)+"_"+dateprint+".csv"
...
if __name__ == "__main__":
    ...
    print("[entry] starting parse_casabianca_listings_v2.py")
