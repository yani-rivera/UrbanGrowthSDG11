...
# in scripts/parse_propiedades_listings_v1.py
...
#==================
 ...
 # Ensure agency comes from args
    ...
    outdir = os.path.join(args.output_dir, "propiedades", year)
    print("outdoe==>",outdir)
...
if __name__ == "__main__":
    ...
    print("[entry] starting parse_propiedades_listings_v2.py")
