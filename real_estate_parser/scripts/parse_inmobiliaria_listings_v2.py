...
# in scripts/parse_inmobliaria_listings_v1.py
...
#==================
 ...
 # Ensure agency comes from args
    ...
    outdir = os.path.join(args.output_dir, "Inmobiliaria", year)
    print("outdoe==>",outdir)
#=========
    if rows:
...
if __name__ == "__main__":
    ...
    print("[entry] starting parse_inmobiliaria_listings_v1.py")
